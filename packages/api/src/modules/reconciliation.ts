...
export async function overrideReconciliation(
  ...
  db.prepare(
    ...
    (original.container_scan_id as string | null) ?? null,
    (original.vin_scan_id as string | null) ?? null,
    String(original.container_no),
    String(original.vin),
    (original.report_id as string | null) ?? null,
    (original.report_version as number | null) ?? null,
    (original.report_line_id as string | null) ?? null,
    args.reasonCode,
