...
| `verification_outcome` | MATCH, WRONG_CONTAINER, WRONG_VEHICLE, CHASSIS_NOT_ON_MANIFEST, CONTAINER_NOT_ON_MANIFEST, ALREADY_COMPLETED, CONTAINER_FULL, ASSIGNMENT_NOT_ACTIVE, MANIFEST_NOT_PUBLISHED, MANIFEST_SUPERSEDED, DRIVER_NOT_AUTHORISED, DEVICE_NOT_APPROVED, EVIDENCE_MISSING, REPLAY_CONFLICT |
